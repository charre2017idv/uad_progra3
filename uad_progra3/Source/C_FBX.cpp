...
/* */
C_FBX::C_FBX(int window_width, int window_height) :
	CApp(window_width, window_height)
{
	cout << "Constructor: C_FBX(int window_width, int window_height)" << endl;
	// Initialize class member variables here
	// ======================================
	m_ShaderID = 0;
	m_geoVAOID = 0;
...
/* */
void C_FBX::update(double deltaTime)
{
...
/* */
void C_FBX::onMouseMove(float deltaX, float deltaY)
{
...
void C_FBX::createSphereTrail(int x, int y)
{
	// Variables
