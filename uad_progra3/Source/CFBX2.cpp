...
/* */
CFBX2::CFBX2(int window_width, int window_height) :
	CApp(window_width, window_height)
{
	cout << "Constructor: CFBX2(int window_width, int window_height)" << endl;
	// Initialize class member variables here
	// ======================================
	m_ShaderID = 0;
	m_geoVAOID = 0;
...
/* */
void CFBX2::update(double deltaTime)
{
...
/* */
void CFBX2::onMouseMove(float deltaX, float deltaY)
{
...
void CFBX2::createSphereTrail(int x, int y)
{
	// Variables
